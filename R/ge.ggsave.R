...
ggsave(pngName,width = width, height = width, scale = scale, dpi = dpi)
ggsave(tifName,width = width, height = width, scale = scale, dpi = dpi)
ggsave(pdfName,width = width, height = width, scale = scale, dpi = dpi)
}
